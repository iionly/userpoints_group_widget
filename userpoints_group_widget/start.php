...
function userpoints_group_widget_init() {
    ...
    if (elgg_is_active_plugin('widget_manager')) {
        //add groups widget
        elgg_register_widget_type('userpoints_group_widget', elgg_echo("userpoints_group_widget:top_group_members"), elgg_echo('userpoints_group_widget:top_group_members'), array("groups"));
    }
}